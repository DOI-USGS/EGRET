...
Table \ref{table:loadestModels} show other predefined models that can be used.
...
Finally, use the \texttt{predLoad} and \texttt{predConc} function to get the rloadest predictions for load and concentration. Use those values to populate the ConcDay and FluxDay. Use the \texttt{fitted} function with type=\texttt{mean} to get unbiased estimate of the mean of the concentration (in EGRET, \texttt{yHat}). Use the \texttt{fitted} function with type=\texttt{response} to get  estimated log concentration (in EGRET, \texttt{ConcHat}).
...
%------------------------------------------------------------
\section{Comparing WRTDS with rloadest using EGRET plots}
%------------------------------------------------------------ 
...
%------------------------------------------------------------
\section{Diognostic rloadest plots}
%------------------------------------------------------------ 
...
\begin{figure}[h]
\includegraphics{figure/ratingCurve.pdf}
\caption{The rating-curve regression model.}
\end{figure}
...
\begin{figure}[h]
\includegraphics{figure/residuals.pdf}
\caption{The residuals versus fit for the regression model.}
\end{figure}
...
\begin{figure}[h]
\includegraphics{figure/scaleLocation.pdf}
\caption{The scale-location graph for the regression model.}
\end{figure}
...
\begin{figure}[h]
\includegraphics{figure/correlogram.pdf}
\caption{The correlogram from the regression model.}
\end{figure}
...
\begin{figure}[h]
\includegraphics{figure/qNormal.pdf}
\caption{The Q-normal plot of the residuals.}
\end{figure}
...
\begin{figure}[h]
\includegraphics{figure/loadestBox.pdf}
\caption{Box plot comparing estimated and observed values.}
\end{figure}
