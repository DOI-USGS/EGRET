...
See section \ref{app:createWordTable} for instructions on converting an R data frame to a table in Microsoft&trade; software. Excel, Microsoft, PowerPoint, Windows, and Word are registered trademarks of Microsoft Corporation in the United States and other countries.
...
\caption{Selected variables used in water quality analysis plots}
...
\caption{Selected variables in WRTDS
...
\caption{Variables used in EGRET contour plots: `plotContours` and `plotDiffContours`
...
\caption{Variables used in EGRET `plotConcQSmooth` and/or `plotConcTimeSmooth` functions
