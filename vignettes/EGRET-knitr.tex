...
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/plotConcTime2} \caption[Default plotLogConcTime (left), and plotConcTime (right)]{Default plotLogConcTime (left), and plotConcTime (right)\label{fig:plotConcTime}}
\end{figure}
...
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-31} 
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-32} \caption[Default plotConcPred (left), and plotFluxPred (right)]{Default plotConcPred (left), and plotFluxPred (right)\label{fig:unnamed-chunk-3}}
\end{figure}
...
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-41} 
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-42} \caption[Default plotLogConcPred (left), and plotLogFluxPred (right)]{Default plotLogConcPred (left), and plotLogFluxPred (right)\label{fig:unnamed-chunk-4}}
\end{figure}
...
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-51} 
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-52} \caption[Default plotResidPred (left), and plotResidQ (right)]{Default plotResidPred (left), and plotResidQ (right)\label{fig:unnamed-chunk-5}}
\end{figure}
...
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-61} 
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-62} \caption[Default plotResidTime (left), and boxResidMonth (right)]{Default plotResidTime (left), and boxResidMonth (right)\label{fig:unnamed-chunk-6}}
\end{figure}
...
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-71} 
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-72} \caption[Default plotConcHist (left), and plotFluxHist (right)]{Default plotConcHist (left), and plotFluxHist (right)\label{fig:unnamed-chunk-7}}
\end{figure}
...
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-81} 
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-82} \caption[Default plotConcQSmooth (left), and plotLogConcQSmooth (right)]{Default plotConcQSmooth (left), and plotLogConcQSmooth (right)\label{fig:unnamed-chunk-8}}
\end{figure}
...
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/unnamed-chunk-9} \caption[Default plotConcTimeSmooth (left)]{Default plotConcTimeSmooth (left)\label{fig:unnamed-chunk-9}}
\end{figure}
...
\includegraphics[width=1\linewidth,height=1\linewidth]{figure/unnamed-chunk-10} \caption[Default fluxBiasMulti]{Default fluxBiasMulti\label{fig:unnamed-chunk-10}}
\end{figure}
...
\includegraphics[width=1\linewidth,height=1\linewidth]{figure/unnamed-chunk-11} \caption[Default plotContours]{Default plotContours\label{fig:unnamed-chunk-11}}
\end{figure}
...
\includegraphics[width=1\linewidth,height=1\linewidth]{figure/unnamed-chunk-12} \caption[Default plotDiffContours]{Default plotDiffContours\label{fig:unnamed-chunk-12}}
\end{figure}
