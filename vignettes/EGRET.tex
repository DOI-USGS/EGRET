...
\end{alltt}
\begin{verbatim}
## There are  49321 data points, and  49321 days.
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## There are  35725 data points, and  35725 days.
\end{verbatim}
\begin{alltt}
...
\hlfunctioncall{legend}(5,.1,\hlstring{"Choptank Nitrogen"}, pch=20, col=\hlstring{"blue"})
\hlfunctioncall{grid}()
\end{alltt}
\end{kframe}\begin{figure}[]
