...
\end{alltt}
\begin{verbatim}
There are 49409 data points, and 49409 days.
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
There are 35813 data points, and 35813 days.
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\end{kframe}\begin{figure}[]
\subfloat[plotConcQ(cex.axis=2,cex.main=1.5)\label{fig:adjustSize1}]{
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/adjustSize1} }
\subfloat[plotConcQ(cex.lab=2,cex=2)\label{fig:adjustSize2}]{
