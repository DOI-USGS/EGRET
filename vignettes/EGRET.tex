...
\end{alltt}
\begin{verbatim}
## There are  49320 data points, and  49320 days.
\end{verbatim}
\begin{alltt}
...
\includegraphics[width=1\linewidth,height=1\linewidth]{figure/plotContours} \caption[plotContours]{plotContours\label{fig:plotContours}}
\end{figure}
...
\includegraphics[width=1\linewidth,height=1\linewidth]{figure/plotDiffContours} \caption[plotDiffContours(year0=2000,yearEnd=2010,qBottom=0]{plotDiffContours(year0=2000,yearEnd=2010,qBottom=0.1,qTop=100,maxDiff=0.8)\label{fig:plotDiffContours}}
\end{figure}
