...
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/boxConcThree_} \caption[Default boxConcThree (left)]{Default boxConcThree (left)\label{fig:boxConcThree(}}
\end{figure}
...
\includegraphics[width=1\linewidth,height=1\linewidth]{figure/fluxBiasMultiAlt} \caption[Default fluxBiasMultiAlt]{Default fluxBiasMultiAlt\label{fig:fluxBiasMultiAlt}}
\end{figure}
...
\includegraphics[width=1\linewidth,height=1\linewidth]{figure/fluxBiasEight} \caption[Default fluxBiasMulti]{Default fluxBiasMulti\label{fig:fluxBiasEight}}
\end{figure}
