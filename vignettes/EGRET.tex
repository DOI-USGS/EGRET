...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error: object 'AnnualResults' not found}}\begin{alltt}
\hlkwd{plotFluxHist}\hlstd{()}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error: object 'AnnualResults' not found}}\end{kframe}
\end{knitrout}
...
\hlkwd{plotContours}\hlstd{(}\hlkwc{yearStart}\hlstd{=}\hlnum{2008}\hlstd{,}\hlkwc{yearEnd}\hlstd{=}\hlnum{2010}\hlstd{,}\hlkwc{qBottom}\hlstd{=}\hlnum{20}\hlstd{,qTop,}
             \hlkwc{contourLevels} \hlstd{= clevel,}\hlkwc{qUnit}\hlstd{=}\hlnum{1}\hlstd{,}
             \hlkwc{flowDuration}\hlstd{=}\hlnum{FALSE}\hlstd{)}
\end{alltt}
\end{kframe}\begin{figure}[]

\includegraphics[width=1\linewidth,height=1\linewidth]{figure/plotContours} \caption[plotContours(yearStart=2008,yearEnd=2010,qBottom=20,qtop=1000,clevel=seq(0,2]{plotContours(yearStart=2008,yearEnd=2010,qBottom=20,qtop=1000,clevel=seq(0,2.5,0.25),qUnit=1)\label{fig:plotContours}}
\end{figure}
...
\includegraphics[width=1\linewidth,height=1\linewidth]{figure/plotDiffContours} \caption[plotDiffContours(year0=2000,year1=2010,qBottom=1,qTop=5000,maxDiff=0]{plotDiffContours(year0=2000,year1=2010,qBottom=1,qTop=5000,maxDiff=0.6,qUnit=1)\label{fig:plotDiffContours}}
\end{figure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error: object 'returnDF' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\color{warningcolor}{Warning: "{}tick.lwd"{} is not a graphical parameter}}\end{kframe}\begin{figure}[]
