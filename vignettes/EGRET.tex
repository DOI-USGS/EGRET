...
INFO$shortName <- \hlstring{"Choptank River at Greensboro, MD"}
...
\hlfunctioncall{plotQTimeDaily}(qLower=1,qUnit=3)
...
\hlfunctioncall{plotConcTimeDaily}()
\hlfunctioncall{plotFluxTimeDaily}()
...
\end{alltt}
\begin{verbatim}
There are  49357 data points, and  49357 days.
\end{verbatim}
\begin{alltt}
INFO <- \hlfunctioncall{getMetaData}(siteID,\hlstring{""},interactive=FALSE)
INFO$shortName <- \hlstring{"Columbia River at The Dalles, OR"}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
There are  35761 data points, and  35761 days.
\end{verbatim}
\begin{alltt}
INFO <- \hlfunctioncall{getMetaData}(sta,\hlstring{""},interactive=FALSE)
INFO$shortName <- \hlstring{"Merced River at Happy Isles Bridge, CA"}
INFO <- \hlfunctioncall{setPA}()
annualSeries <- \hlfunctioncall{makeAnnualSeries}()
...
\end{alltt}
\begin{verbatim}
There are  49489 data points, and  49489 days.
\end{verbatim}
\begin{alltt}
INFO <- \hlfunctioncall{getMetaData}(sta,\hlstring{""},interactive=FALSE)
...
\hlfunctioncall{plotQTimeDaily}(qUnit=3,qLower=300)
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{Error: argument "startYear" is missing, with no default}}\end{kframe}
\end{knitrout}
...
\end{alltt}
\end{kframe}\begin{figure}[]
\subfloat[plotConcQSmooth\label{fig:plotConcTimeSmooth1}]{
\includegraphics[width=.5\linewidth,height=.5\linewidth]{figure/plotConcTimeSmooth1} }
\subfloat[plotLogConcQSmooth(logScale=TRUE)\label{fig:plotConcTimeSmooth2}]{
