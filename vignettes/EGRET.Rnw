...
<<harderFontChange,echo=TRUE,eval=TRUE,fig.cap="Comic Sans MS font",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth',warning=FALSE, message=FALSE>>=
library(extrafont)
# The first time you use extrafont, you'll need to run: 
# font_import()
# To then see your font options:
# fonts()
par(family="Comic Sans MS")
plotFluxPred(customPar=TRUE)
mtext(side=3,line=-3,"Comic sans font example",cex=2)
@
\FloatBarrier
