...
<<newChunckAS, echo=TRUE,eval=FALSE>>=
...
<<label=figBox2, fig=TRUE,echo=FALSE>>=
<<box2>>
@
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<<plotConcTimeSmooth, echo=FALSE,eval=TRUE, results=hide>>=
plotConcTimeSmooth(q1, q2, q3, centerDate, 2000, yearEnd)
@
...
<<label=figplotConcTimeSmooth, fig=TRUE,echo=FALSE, results=hide>>=
<<plotConcTimeSmooth>>
@
