...
<<plotDiffContours, echo=FALSE, fig.cap="plotDiffContours(year0=2000,yearEnd=2010,qBottom=0.1,qTop=100,maxDiff=0.8)",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
plotDiffContours(year0=2000,yearEnd,
                 qBottom,qTop,maxDiff)
@
