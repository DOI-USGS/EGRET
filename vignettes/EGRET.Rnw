...
<<plotConcTimeDaily, echo=TRUE, fig.cap="Concentration and flux vs time",fig.subcap=c("plotConcTimeDaily(yearStart=2008, yearEnd=2010)","plotFluxTimeDaily(yearStart=2008, yearEnd=2010)"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
yearStart <- 2008
yearEnd <- 2010
