...
<<plotConcTimeSmooth, echo=TRUE, fig.cap="plotConcTimeSmooth",fig.subcap=c("plotConcQSmooth","plotLogConcQSmooth(logScale=TRUE)"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold',results='hide'>>=
q1 <- 10
q2 <- 25
q3 <- 75
centerDate <- "07-01"
...
<<adjustSize,echo=TRUE,eval=TRUE,fig.cap="Modifying text and point size", fig.subcap=c("plotLogConcQ(cex.axis=2,cex.main=1.5)","plotLogConcQ(cex.lab=2,cex=2)"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
