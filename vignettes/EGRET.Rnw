...
%------------------------------------------------------------ 
Subsequent sections of this vignette will discuss the EGRET workflow steps in greater detail. This section provides a handy cheat sheet for diving into a EGRET analysis.
...
We will walk through an example from the Rio Grande streamgage in Embodo, NM.  This is the first streamgage in the USGS, established by John Wesley Powell in 1888.
...
<<flowHistoryGetData,echo=FALSE,eval=TRUE>>=
Daily <- RioDaily
INFO <- RioINFO
@
...
<<plotSingleandSD, echo=FALSE, fig.cap="Discharge statistics",fig.subcap=c("plotFlowSingle(istat=5,qUnit='thousandCfs')","plotSDLogQ"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotFlowSingle(istat=5,qUnit="thousandCfs")
plotSDLogQ()
@

<<plotQTimeDaily,echo=FALSE, fig.cap="plotQTimeDaily(1990,2010,qLower=2,qUnit=3)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotQTimeDaily(1990,2010,qLower=2,qUnit=3)
@

<<plotFour, echo=FALSE, fig.cap="plotFour(qUnit=3)",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
plotFour(qUnit=3)
@

<<plotFourStats,echo=FALSE, fig.cap="plotFourStats(qUnit=3)",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
plotFourStats(qUnit=3)
@
...
<<red, echo=TRUE,eval=TRUE,fig.cap="Red River plotSDLogQ Example",fig.subcap=c("June-Aug", "March-May"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
siteID <- "05082500"
...
<<eval=TRUE,echo=TRUE>>=
annualSeries <- makeAnnualSeries()
tableFlowChange(istat=3, qUnit=3,yearPoints=c(1930,1970,2010))
@
...
<<plotBoxes, echo=FALSE, fig.cap="Concentration box plots",fig.subcap=c("boxConcMonth","boxQTwice"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
boxConcMonth()
boxQTwice()
@

<<plotConcTime,echo=FALSE, fig.cap="Concentration vs time",fig.subcap=c("plotConcTime","plotLogConcTime"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcTime()
plotLogConcTime()
@

<<plotConcQ, echo=FALSE, fig.cap="Concentration vs discharge",fig.subcap=c("plotConcQ","plotLogConcQ"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcQ()
plotLogConcQ()
@

<<plotLogConcQ, echo=FALSE, fig.cap="Flux vs discharge",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotLogFluxQ()
@

<<multiPlotDataOverview, echo=FALSE, fig.cap="multiPlotDataOverview",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
multiPlotDataOverview()
@
...
<<plotConcTimeDaily, echo=FALSE, fig.cap="Concentration and flux vs time",fig.subcap=c("plotConcTimeDaily","plotFluxTimeDaily"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
Sample <- ChopSample
Daily <- ChopDaily
INFO <- ChopINFO
AnnualResults <- setupYears()
...
<<plotFluxPred, echo=FALSE, fig.cap="Concentration predictions",fig.subcap=c('plotConcPred','plotLogConcPred'),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcPred()
plotLogConcPred()
@

<<plotLogFluxPred, echo=FALSE, fig.cap="Flux predictions",fig.subcap=c('plotFluxPred','plotLogFluxPred'), out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotFluxPred()
plotLogFluxPred()
@

<<plotResidQ, echo=FALSE, fig.cap="Residuals",fig.subcap=c("plotResidPred","plotResidQ"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotResidPred()
plotResidQ()
@

<<boxResidMonth, echo=FALSE, fig.cap="Residuals with respect to time",fig.subcap=c("plotResidTime","boxResidMonth"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotResidTime()
boxResidMonth()
@

<<boxConcThree, echo=FALSE, fig.cap="Default boxConcThree",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='asis',results='hide'>>=
boxConcThree()
@

<<plotFluxHist, echo=FALSE, fig.cap="Concentration and flux history",fig.subcap=c("plotConcHist", "plotFluxHist"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcHist()
plotFluxHist()
@

<<plotLogConcQSmooth, echo=FALSE, fig.cap="Concentration vs. discharge",fig.subcap=c("plotConcQSmooth","plotLogConcQSmooth"),out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcQSmooth(date1, date2, date3, qBottom, qTop, 
                   concMax=2)
plotLogConcQSmooth(date1, date2, date3, qBottom, qTop, 
                   concMax=2, concMin=0.1)
...
<<plotConcTimeSmooth, echo=FALSE, fig.cap="plotConcTimeSmooth",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='asis',results='hide'>>=
plotConcTimeSmooth(q1, q2, q3, centerDate, 2000, yearEnd)
@

<<fluxBiasMulti, echo=FALSE, fig.cap="fluxBiasMulti",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
fluxBiasMulti()
@

<<fluxBiasMultiAlt, echo=FALSE, fig.cap="fluxBiasMultiAlt",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
fluxBiasMultiAlt()
@

<<fluxBiasEight, echo=FALSE, fig.cap="fluxBiasEight",fig.show='asis',fig.width=8, fig.height=10>>=
fluxBiasEight()
@

<<plotContours, echo=FALSE, fig.cap="plotContours",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
surfaces <- exsurfaces
Daily <- exDaily
INFO <- exINFO
plotContours(yearStart,yearEnd,qBottom,qTop, 
...
<<plotDiffContours, echo=FALSE, fig.cap="plotDiffContours",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
plotDiffContours(year0=2000,yearEnd,
                 qBottom,qTop,maxDiff)
@
...
<<tableResults2, eval=FALSE,echo=TRUE,results='hide'>>=
library(xtable)
...
<<tableChange2, echo=TRUE, eval=TRUE,results='hide'>>=
library(xtable)
...
<<openLibraryPartDeux, eval=FALSE>>=
library(dataRetrieval)
library(EGRET)
@
