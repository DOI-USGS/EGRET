...
<<plotSingleandSD, echo=FALSE, fig.cap="plotFlowSingle (left), default plotSDLogQ (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotFlowSingle(istat=7,qUnit="thousandCfs")
plotSDLogQ()
@

<<plotQTimeDaily,echo=FALSE, fig.cap="plotQTimeDaily",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotQTimeDaily(1990,2010,qLower=2,qUnit=3)
@

<<plotFour, echo=FALSE, fig.cap="plotFour",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
plotFour(qUnit=3)
@

<<plotFourStats,echo=FALSE, fig.cap="plotFourStats",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
plotFourStats(qUnit=3)
@
...
<<red, echo=TRUE,eval=TRUE,fig.cap="Red River Standard Deviation Example",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
siteID <- "05082500"
...
<<plotBoxes, echo=FALSE, fig.cap="Default boxConcMonth (left), and boxQTwice (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
boxConcMonth()
boxQTwice()
@

<<plotConcTime,echo=FALSE, fig.cap="Default plotConcTime (left), and plotLogConcTime (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcTime()
plotLogConcTime()
@

<<plotConcQ, echo=FALSE, fig.cap="Default plotConcQ (left), and plotLogConcQ (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcQ()
plotLogConcQ()
@

<<plotLogConcQ, echo=FALSE, fig.cap="Default plotLogConcQ (left), and plotLogFluxQ (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotLogConcQ()
plotLogFluxQ()
@
...
<<plotConcTimeDaily, echo=FALSE, fig.cap="Default plotConcTimeDaily (left), and plotFluxTimeDaily (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
Sample <- ChopSample
Daily <- ChopDaily
INFO <- ChopINFO
AnnualResults <- setupYears()
...
<<plotFluxPred, echo=FALSE, fig.cap="Default plotConcPred (left), and plotFluxPred (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcPred()
plotFluxPred()
@

<<plotLogFluxPred, echo=FALSE, fig.cap="Default plotLogConcPred (left), and plotLogFluxPred (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotLogConcPred()
plotLogFluxPred()
@

<<plotResidQ, echo=FALSE, fig.cap="Default plotResidPred (left), and plotResidQ (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotResidPred()
plotResidQ()
@

<<boxResidMonth, echo=FALSE, fig.cap="Default plotResidTime (left), and boxResidMonth (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotResidTime()
boxResidMonth()
@

<<boxConcThree(, echo=FALSE, fig.cap="Default boxConcThree (left)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='asis',results='hide'>>=
boxConcThree()
@

<<plotFluxHist, echo=FALSE, fig.cap="Default plotConcHist (left), and plotFluxHist (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcHist()
plotFluxHist()
@

<<plotLogConcQSmooth, echo=FALSE, fig.cap="Default plotConcQSmooth (left), and plotLogConcQSmooth (right)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='hold'>>=
plotConcQSmooth(date1, date2, date3, qBottom, qTop, 
                   concMax=2)
plotLogConcQSmooth(date1, date2, date3, qBottom, qTop, 
                   concMax=2, concMin=0.1)
...
<<plotConcTimeSmooth(, echo=FALSE, fig.cap="Default plotConcTimeSmooth (left)",out.width='.5\\linewidth',out.height='.5\\linewidth',fig.show='asis',results='hide'>>=
plotConcTimeSmooth(q1, q2, q3, centerDate, 2000, yearEnd)
@

<<fluxBiasMulti, echo=FALSE, fig.cap="Default fluxBiasMulti",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
fluxBiasMulti()
@

<<fluxBiasMultiAlt, echo=FALSE, fig.cap="Default fluxBiasMultiAlt",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
fluxBiasMultiAlt()
@

<<fluxBiasEight, echo=FALSE, fig.cap="Default fluxBiasMulti",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
fluxBiasEight()
@


<<plotContours, echo=FALSE, fig.cap="Default plotContours",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
surfaces <- exsurfaces
Daily <- exDaily
INFO <- exINFO
plotContours(yearStart,yearEnd,qBottom,qTop, 
...
<<plotDiffContours, echo=FALSE, fig.cap="Default plotDiffContours",fig.show='asis',out.width='1\\linewidth',out.height='1\\linewidth'>>=
plotDiffContours(year0=2000,yearEnd,
                 qBottom,qTop,maxDiff)
@
...
<<tableResults2, echo=TRUE,eval=FALSE>>=
