...
For a thorough use case of the EGRET enhancements, see the paper: "Tracking changes in nutrient delivery to western Lake Erie: Approaches to compensate for variability and trends in streamflow" (https://www.sciencedirect.com/science/article/pii/S0380133018302235).
...
```{r runSeries, echo=TRUE, eval=TRUE}
