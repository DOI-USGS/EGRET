...
In this first example we will specify that **year1** is 1985 and **year2** is 2014 and we will not have a wall, and we will use automatic flow window designation, with a **windowSide** value of 7. The analyses shown here use  data retrieved at the time this document was prepared (2018-08-14).  It is possible that data retrieved from future retrievals could be slightly different (although we'd expect only slight differences).
