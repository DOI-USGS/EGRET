...
ColumnName <- c("shortName", "staAbbrev", "paramShortName", "constitAbbrev","drainSqKm")
Type <- c("string", "string","string", "string","numeric")
Description <- c("Name of site, suitable for use in graphical headings", "Abbreviation for station name, used in saveResults","Name of constituent, suitable for use in graphical headings", "Abbreviation for constituent name, used in saveResults","Drainage area in km^2")
