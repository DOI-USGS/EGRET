...
% An interesting comparison might be between spring and summer on the Red River of the North (Figure \ref{fig:red}).  This figure shows that there is generally more variability in discharge in the spring compared to the summer.
...
\begin{Soutput}
 ...
 1950  to  1990        0.025      0.00063          9.4         0.23
...
\end{center}
\caption{Default plotConcTimeSmooth}
...
%------------------------------------------------------------ 
\subsection{WRTDS Analysis Input}
