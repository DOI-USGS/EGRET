...
An recent presentation on an overview of `dataRetrieval` and `EGRETdemo` can be found here:
[dataRetrieval and EGRETdemo 2014-10-07.pdf](https://github.com/USGS-R/EGRETdemo/blob/gh-pages/images/dataRetrieval%20and%20EGRET%202014-10-07.pdf?raw=true)
...
To install the EGRETdemo and dataRetrieval packages you need to be using R 3.0 or greater. Then use the following command:
