...
[![Research software
impact](http://depsy.org/api/package/cran/EGRET/badge.svg)](http://depsy.org/package/r/EGRET)
...
Please visit the wiki for more information: [EGRET
Wiki](https://github.com/USGS-R/EGRET/wiki)
...
![](man/figures/startPlots-6.png)

``` r
plotFluxTimeDaily(eList)
```

![](man/figures/startPlots-7.png)

``` r
plotConcPred(eList)
```

![](man/figures/startPlots-8.png)

``` r
plotFluxPred(eList)
```

![](man/figures/startPlots-9.png)

``` r
plotResidPred(eList)
```

![](man/figures/startPlots-10.png)

``` r
plotResidQ(eList)
```

![](man/figures/startPlots-11.png)

``` r
plotResidTime(eList)
```

![](man/figures/startPlots-12.png)

``` r
boxResidMonth(eList)
```

![](man/figures/startPlots-13.png)

``` r
boxConcThree(eList)
```

![](man/figures/startPlots-14.png)
...
![](man/figures/startPlots-15.png)

``` r
plotFluxHist(eList)
```

![](man/figures/startPlots-16.png)
