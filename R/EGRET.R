...
multiPlotDataOverview<-function (localSample = Sample, localDaily = Daily, localINFO = INFO, qUnit = 2){
  par(mfcol=c(2,2),oma=c(0,2.4,4.5,2.4))
	...
	boxConcMonth(localSample = localSample, printTitle = FALSE)
	plotLogConcTime(localSample = localSample, printTitle = FALSE, tinyPlot = TRUE)
	boxQTwice(localSample = localSample, localDaily = localDaily, printTitle = FALSE, qUnit = qUnit)
...
# fluxUnit is the units you want the results displayed in, see manual for list of all possible units  
  ...
  ################################################################################
	...
	if(plotFlowNorm) plot(subAnnualResults$DecYear,fnFlux,axes=FALSE,xlim=c(xLeft,xRight),xaxs="i",xlab="",ylim=c(0,yTop),yaxs="i",ylab="",main="",type="l",col="green",lwd=3,cex=0.8,cex.main=1.1,cex.lab=1.2,font=2)
	axis(1,tcl=0.5,at=xTicks,labels=xTicks)
...
#' @export
#' @examples
#' plotLogConcPred(localSample = exSampleEnd, localINFO = exINFOEnd)
...
#' @export
#' @examples
#' plotLogFluxPred(localSample = exSampleEnd, localINFO = exINFOEnd, fluxUnit = 1)
#' plotLogFluxPred(localSample = exSampleEnd, localINFO = exINFOEnd, fluxUnit = 'kgDay')
...
#' @export
#' @examples
#' plotResidPred(localSample = exSampleEnd, localINFO = exINFOEnd)
...
#' @export
#' @examples
#' plotResidTime(localSample = exSampleEnd, localINFO = exINFOEnd)
