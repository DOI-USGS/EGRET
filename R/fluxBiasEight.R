...
fluxBiasEight<-function (localSample = Sample, localDaily = Daily, 
  ...
  boxConcThree(localSample = localSample, localDaily = localDaily, localINFO = localINFO, printTitle=FALSE, tinyPlot=TRUE)
  plotConcPred(localSample = localSample, localINFO=localINFO, printTitle=FALSE, tinyPlot=TRUE)
  boxQTwice(localSample = localSample, localDaily = localDaily, 
            localINFO = localINFO, printTitle = FALSE, qUnit = qUnit,tinyPlot=TRUE)
