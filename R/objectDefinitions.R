...
fluxConst <- list(
  poundsDay = new(
    ...
    unitEstimate = expression("flux in pounds/day"),
  ...
  tonsDay = new(
    ...
    unitEstimate = expression("flux in tons/day"),
  ...
  kgDay = new(
    ...
    unitEstimate = expression("flux in kg/day"),
  ...
  thousandKgDay = new(
    ...
    unitEstimate = expression(paste("flux in ", 10^3 * kg / day)),
  ...
  thousandTonsYear = new(
    ...
    unitEstimate = expression(paste("flux in ", 10^3 * tons / yr)),
    unitEstimateTiny = expression(paste(
      "Est. flux ",
      "(",
      10^3 * tons / yr,
      ")"
  ...
  millionTonsYear = new(
    ...
    unitEstimate = expression(paste("flux in ", 10^6 * tons / yr)),
    unitEstimateTiny = expression(paste(
      "Est. flux ",
      "(",
      10^6 * tons / yr,
  ...
  thousandKgYear = new(
    ...
    unitEstimate = expression(paste("flux in ", 10^3 * kg / yr)),
    unitEstimateTiny = expression(paste(
      "Est. flux ",
      "(",
      10^3 * kg / yr,
  ...
  millionKgYear = new(
    ...
    unitEstimate = expression(paste("flux in ", 10^6 * kg / yr)),
    unitEstimateTiny = expression(paste(
      "Est. flux ",
      "(",
      10^6 * kg / yr,
  ...
  billionKgYear = new(
    ...
    unitEstimate = expression(paste("flux in", 10^9 * kg / yr)),
    unitEstimateTiny = expression(paste(
      "Est. flux ",
      "(",
      10^9 * kg / yr,
  ...
  thousandTonsDay = new(
    ...
    unitEstimate = expression(paste("flux in ", 10^3 * tons / day)),
    unitEstimateTiny = expression(paste(
      "Est. flux ",
      "(",
      10^3 * tons / d,
  ...
  millionKgDay = new(
    ...
    unitEstimate = expression(paste("flux in ", 10^6 * kg / day)),
  ...
  kgYear = new(
    ...
    unitEstimate = expression("flux in kg/year"),
