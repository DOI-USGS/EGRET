...
runGroups <- function(
  ...
  annFlex1 <- annFlex[
    annFlex$DecYear >= group1firstYear & annFlex$DecYear <= group1lastYear,
  ]
  annSta1 <- annSta[
    annSta$DecYear >= group1firstYear & annSta$DecYear <= group1lastYear,
  ]
  annFlex2 <- annFlex[
    annFlex$DecYear >= group2firstYear & annFlex$DecYear <= group2lastYear,
  ]
  annSta2 <- annSta[
    annSta$DecYear >= group2firstYear & annSta$DecYear <= group2lastYear,
  ]
  ...
  groupResults[1, ] <- c(cDeltaTotal, cRSpart, cFDpart, c10, c11, c20, c22)
  groupResults[2, ] <- 0.00036525 *
...
printGroups <- function(eList, groupResults) {
  ...
  cat(
    ...
    groupInfo["group2firstYear"],
    " through",
    groupInfo["group2lastYear"],
    " minus average of",
    groupInfo["group1firstYear"],
    " through",
    groupInfo["group1lastYear"],
    "\n"
  )
